...
const checks = [
  ...
  {
    label: 'Suppliers business health controller',
    path: path.join(githubRoot, 'suppliers-microservice/src/business-health/business-health.controller.ts'),
    snippets: [
      '@Controller("business-health")',
      '@Public()',
  ...
  {
    label: 'Suppliers business health service',
    path: path.join(githubRoot, 'suppliers-microservice/src/business-health/business-health.service.ts'),
    snippets: [
      ...
      'productionDbQueried: false',
      'liveSyntheticMutationAuthorized: false',
      'real supplier procurement readiness',
    ],
  },
  {
    label: 'Suppliers business health types',
    path: path.join(githubRoot, 'suppliers-microservice/src/business-health/business-health.types.ts'),
    snippets: [
  ...
  {
    label: 'Suppliers traceability verifier',
    path: path.join(githubRoot, 'suppliers-microservice/scripts/verify-business-health-suppliers-traceability-contract.js'),
    snippets: [
      'suppliers.supplier_warehouse_traceability_business_health.v1',
      'forbiddenEndpointPatternsChecked',
      'mutatesSuppliers',
