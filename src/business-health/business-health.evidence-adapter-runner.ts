...
const ADAPTER_DEFINITIONS: StaticAdapterDefinition[] = [
  ...
  },
  {
    ...
    status: 'warn',
    summary:
      'Marketplace inventory exists; Aukro read-only channel readback endpoint exists; Heureka read-only channel readback endpoint exists; remaining channel envelopes and live provider proofs are gated.',
    sourceRefs: [
