...
| Marketplace channel readback inventory | `business-process-control-plane` + channel repos | `docs/orchestrator/2026-07-06-marketplace-channel-business-health-inventory.md`; Aukro `GET /aukro/business-health/channel-readback`; `aukro/services/aukro-service/src/business-health/**`; `aukro/scripts/verify-business-health-aukro-channel-contract.js` | partial source endpoint ready; remaining channel envelopes gated | static source endpoint only; no provider calls, no marketplace mutation, no production DB/API query |
