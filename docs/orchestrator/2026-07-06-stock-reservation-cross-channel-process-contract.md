...
| Marketplace/channel services | Channel-specific listing readiness, external readback, availability convergence, provider policy boundaries. | Warehouse stock authority, order/payment domain finality. | `[RESOLVED/PARTIAL: Aukro read-only channel readback evidence endpoint exists at GET /aukro/business-health/channel-readback]`; `[RESOLVED/PARTIAL: Heureka read-only channel readback evidence endpoint exists at GET /heureka/business-health/channel-readback]`; `[RESOLVED/PARTIAL: Allegro read-only channel readback evidence endpoint exists at GET /allegro/business-health/channel-readback]`; `[MISSING: FlipFlop/Bazos service-owned channel readback endpoints]`; `[MISSING: per-channel live provider readback packets and external mutation policies]` |
