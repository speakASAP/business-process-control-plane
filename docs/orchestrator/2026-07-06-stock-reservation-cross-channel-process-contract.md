...
| Marketplace/channel services | Channel-specific listing readiness, external readback, availability convergence, provider policy boundaries. | Warehouse stock authority, order/payment domain finality. | `[RESOLVED/PARTIAL: Aukro read-only channel readback evidence endpoint exists at GET /aukro/business-health/channel-readback]`; `[RESOLVED/PARTIAL: Heureka read-only channel readback evidence endpoint exists at GET /heureka/business-health/channel-readback]`; `[RESOLVED/PARTIAL: Allegro read-only channel readback evidence endpoint exists at GET /allegro/business-health/channel-readback]`; `[RESOLVED/PARTIAL: Bazos read-only channel readback evidence endpoint exists at GET /bazos/business-health/channel-readback]`; `[MISSING: FlipFlop service-owned channel readback endpoint]`; `[MISSING: per-channel live provider readback packets and external mutation policies]` |
...
- `[RESOLVED/PARTIAL: Aukro read-only channel readback evidence endpoint exists at GET /aukro/business-health/channel-readback]`
- `[RESOLVED/PARTIAL: Heureka read-only channel readback evidence endpoint exists at GET /heureka/business-health/channel-readback]`
- `[MISSING: FlipFlop service-owned channel readback business-health endpoint]`
- `[RESOLVED/PARTIAL: Bazos read-only channel readback evidence endpoint exists at GET /bazos/business-health/channel-readback]`
- `[MISSING: approved live Bazos readback packet]`
- `[RESOLVED/PARTIAL: Allegro read-only channel readback evidence endpoint exists at GET /allegro/business-health/channel-readback]`
- `[MISSING: approved live Allegro readback packet]`
- `[MISSING: per-marketplace live availability readback evidence and provider semantics]`
