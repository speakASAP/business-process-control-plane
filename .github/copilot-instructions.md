# Copilot Instructions — `business-process-control-plane`
...
- **Authoritative path**: `/home/ssf/Documents/Github/business-process-control-plane` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/business-process-control-plane.git`, branch `main`.
